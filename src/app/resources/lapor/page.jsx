            ...
            <div className="md:w-3/4 w-full mb-24 overflow-x-hidden">
              ...
              <article class="mb-24">
                <section class="article-container">
                  ...
                  <iframe class="rounded md:w-[560px] md:h-[315px] w-[95vw] h-[25vh]" src="https://www.youtube.com/embed/UuKxh-hsD68?si=bwjJ8PQyHygjqWeC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
