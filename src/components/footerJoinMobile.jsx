...
export default function FooterJoinMobile(){
    ...
    return (
        <div className="flex flex-col items-center text-center gap-2 bg-[var(--main-5)] px-16 py-8 text-[var(--main-1)] relative">
            <h2 className="manrope-h2 text-lg px-2">Join our community to keep up to date on our latest activities</h2>
            <p className="text-xs">Lorem ipsum odor amet, consectetuer adipiscing elit. </p>
