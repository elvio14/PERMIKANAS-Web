...
export default function HomeMobile() {
    ...
    return (
        <div className="flex flex-col gap-4 items-center mb-16 text-center">  
            ...
            <h2 className="manrope-h2 text-xl my-2 text-[var(--main-5)]">Unite, Ignite, Reach New Heights</h2>
            <div className="mx-8 text-center">PERMIKA Nasional is more than a network—it’s a home away from home for Indonesian students across Canada.</div>
