        ...
        <div className="flex flex-col gap-8 z-20
            ...
            <div className="flex flex-row mx-auto md:mx-0 gap-2 md:gap-8 h-[4rem] md:h-[10rem] text-[var(--main-5)]">
                ...
                md:w-[12rem] md:my-[1rem]">
                    ...
                    <h3 className="text-[12px] md:text-base">Cities</h3>                        
                </div>
                <div className="bg-[var(--main)] inline-block border-transparent rounded-xl rounded-tl-none shadow-xl
                flex flex-col justify-center items-center gap-1
                w-[28vw] my-1 py-[2.5rem] px-1
                md:w-[12rem] md:my-[1rem]">
                    ...
                    <h3 className="text-[12px] md:text-base">Chapters</h3>                        
                </div>
            </div>
            <div>
